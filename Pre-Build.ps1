...
Copy-Item $PSScriptRoot\tf-vc-shared\v2\ps_modules\VstsTaskSdk\* $PSScriptRoot\tf-vc-fixparallel\v2\ps_modules\VstsTaskSdk\ -force -recurse -exclude *.*proj
Copy-Item $PSScriptRoot\tf-vc-shared\v2\ps_modules\VstsTaskSdk\* $PSScriptRoot\tf-vc-fixparallel-log\v2\ps_modules\VstsTaskSdk\ -force -recurse -exclude *.*proj